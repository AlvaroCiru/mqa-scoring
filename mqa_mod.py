...
def main(file_path):
  ...
  mqa_modified = 0
  mqa_title = ''
  weight, mqa_shacl = edp_validator(file_path, weight, mqa_shacl)
  ...
  return weight, weight_extra, mqa_keyword, mqa_theme, mqa_spatial, mqa_temporal, mqa_access, mqa_download, mqa_download_access, mqa_format, mqa_media, mqa_media_voc, mqa_non_propietary, mqa_machine_readable, mqa_shacl, mqa_license, mqa_license_voc, mqa_rights, mqa_rights_voc, mqa_contact, mqa_publisher, mqa_rights2, mqa_bytesize, mqa_issued, mqa_modified, n_keywords, valuable_keywords, relation_keywords, file_size, standard_time, recent_time, standard_theme, relation_theme, temp_recent, mqa_title 
  
  
if __name__ == "__main__":

  parser = argparse.ArgumentParser(description="Lee el contenido de un archivo.")
  parser.add_argument('file', type=str, help='La ruta al archivo que se va a leer')
